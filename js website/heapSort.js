...
//     while(this.heap[leftChild] && this.heap[leftChild] > this.heap[index] || this.heap[this.rightChildIndex] > this.heap[index]){
//         var max = rightChild;
...
//reference : https://stackabuse.com/heap-sort-in-javascript